...
\lstset{language=C,caption={CUDA implementation Makefile},label=cuda_rf_make}
\lstinputlisting{appendix/open_hdr/Makefile}

\lstset{language=C,caption={CUDA implementation Makefile Configuration},label=cuda_rf_make_config}
\lstinputlisting{appendix/open_hdr/Makefile.config}
