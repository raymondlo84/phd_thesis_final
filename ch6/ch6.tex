...
%so that the people under surveillance can't see which way the cameras
...
Many buildings and other places where cameras and smart phones are forbidden
...
%, but simply the nuissance factors of sensors that malfunction when operating.
...
%
%Sousveillance is a more recent concept and phenonemon made possible by
...
%
%The problem with local timestamps is, they're easily falsified,
...
%that a video isn't postdated; this is a well-known trope of kidnappers
...
%the time-window quite a bit, since the video capture must have been between
...
%accepted the image hash upload.  Looking at a clock doesn't help at
%all, since they're easily falsified or accidentally erroneous
...
%that they are published frequently, are typically not predictable, and
