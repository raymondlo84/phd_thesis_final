...
Fundamentally, human sensory capacity is ``bandwidth-limited". There are limits to how far humans can see, or how much information they can process, 
...
3. Toposcuplting (topological sculpting), i.e. using 3D gesture-recognition for computational lightpainting by way of wearable computational photography for abakographic user-interfaces~\cite{patentmetabakography}. Subsequently, Gribetz (CEO and co-founder), Mann (Chief Scientist and co-founder), and Lo (Chief Technology Officer and co-founder) joined forces to found the new company Meta Company, and introduce to the world the concept of Extramissive Spatial Imaging Glass~\cite{gribetz2014extramissive}. 
